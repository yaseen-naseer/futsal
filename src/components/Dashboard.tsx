...
import { Monitor, BarChart3, Timer } from 'lucide-react';
import { TeamSettings } from './dashboard/TeamSettings';
import { TimerControls } from './dashboard/TimerControls';
import { FormatSelection } from './dashboard/FormatSelection';
...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const tabs: Array<'teams' | 'timer' | 'format' | 'settings'> = ['teams', 'timer', 'format', 'settings'];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'format' && (
          <FormatSelection
            gamePreset={gameState.gamePreset}
            changeGamePreset={changeGamePreset}
          />
        )}

        {/* Settings Tab */}
        {activeTab === 'settings' && (
          <SettingsPanel resetGame={resetGame} updateTeam={updateTeam} />
        )}
      </div>
    </div>
  );
