...
import { Upload, Play, Pause, RotateCcw, Plus, Minus } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <Upload className="w-4 h-4" />
                Upload Logo
                <input type="file" accept="image/*" onChange={(e) => handleImageUpload('home', e)} className="hidden" />
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-3xl font-bold text-blue-600 min-w-[4rem] text-center">{gameState.homeTeam.score}</span>
              <button
                onClick={() => adjustScore('home', 1)}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-red-600 min-w-[3rem] text-center">{gameState.homeTeam.fouls}</span>
              <button
                onClick={() => adjustFouls('home', 1)}
                className="w-10 h-10 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 flex items-center justify-center transition-colors"
              >
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <label className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                <Upload className="w-4 h-4" />
                Upload Logo
                <input type="file" accept="image/*" onChange={(e) => handleImageUpload('away', e)} className="hidden" />
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-3xl font-bold text-red-600 min-w-[4rem] text-center">{gameState.awayTeam.score}</span>
              <button
                onClick={() => adjustScore('away', 1)}
                className="w-10 h-10 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-red-600 min-w-[3rem] text-center">{gameState.awayTeam.fouls}</span>
              <button
                onClick={() => adjustFouls('away', 1)}
                className="w-10 h-10 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 flex items-center justify-center transition-colors"
              >
